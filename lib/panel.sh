...
function get_or_create_nest(
    ...
    /*
     * Cari berdasarkan nama secara global.
     */
    ...
    if ($nest) {
        ...
        /*
         * Perbaiki description jika kosong.
         */
 ...
 * IMPORT EGG
 *
 * EGG TIDAK BOLEH DUPLIKAT SECARA GLOBAL
 * ==========================================================
 */
...
function import_egg(
     ...
     * PENTING:
     *
     * JANGAN hanya memakai nest_id.
     *
     * Jika Egg sudah ada di Nest manapun,
     * installer tidak membuat Egg baru.
     * ======================================================
     */
    ...
    if ($existing) {
        ...
        /*
         * Pastikan variable lama juga diperiksa.
         *
         * Ini penting jika Egg sudah ada dari
         * instalasi sebelumnya tetapi variable
         * belum lengkap.
         */
